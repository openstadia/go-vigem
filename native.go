...
var (
	dll                                   = syscall.NewLazyDLL("vigemclient.dll")
	...
	ProcTargetDS4Alloc                    = dll.NewProc("vigem_target_ds4_alloc")
	ProcTargetFree                        = dll.NewProc("vigem_target_free")
	ProcTargetAdd                         = dll.NewProc("vigem_target_add")
	ProcTargetAddAsync                    = dll.NewProc("vigem_target_add_async")
	...
	ProcTargetDS4RegisterNotification     = dll.NewProc("vigem_target_ds4_register_notification")
	ProcTargetX360UnregisterNotification  = dll.NewProc("vigem_target_x360_unregister_notification")
	ProcTargetDS4UnregisterNotification   = dll.NewProc("vigem_target_ds4_unregister_notification")
	ProcTargetSetVid                      = dll.NewProc("vigem_target_set_vid")
	ProcTargetSetPid                      = dll.NewProc("vigem_target_set_pid")
	ProcTargetGetVid                      = dll.NewProc("vigem_target_get_vid")
	ProcTargetGetPid                      = dll.NewProc("vigem_target_get_pid")
	ProcTargetX360Update                  = dll.NewProc("vigem_target_x360_update")
	ProcTargetDS4Update                   = dll.NewProc("vigem_target_ds4_update")
	ProcTargetDS4UpdateEx                 = dll.NewProc("vigem_target_ds4_update_ex")
	ProcTargetGetIndex                    = dll.NewProc("vigem_target_get_index")
	ProcTargetGetType                     = dll.NewProc("vigem_target_get_type")
	ProcTargetIsAttached                  = dll.NewProc("vigem_target_is_attached")
	ProcTargetX360GetUserIndex            = dll.NewProc("vigem_target_x360_get_user_index")
	ProcTargetDS4AwaitOutputReport        = dll.NewProc("vigem_target_ds4_await_output_report")
	ProcTargetDS4AwaitOutputReportTimeout = dll.NewProc("vigem_target_ds4_await_output_report_timeout")
)
